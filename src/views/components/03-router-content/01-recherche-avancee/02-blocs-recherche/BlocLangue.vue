                  ...
                  <v-row no-gutters>
                     ...
                     <v-col xs="12" sm="8" lg="9" class="text--secondary">
                        <v-fade-transition leave-absolute>
                           ...
                           <span v-else key="1">
                              {{ getLangueEntered + ' | Entre les langues: ' + getInternalOperatorSelectedInString }}
                           </span>
                        </v-fade-transition>
                     </v-col>
                  </v-row>
...
export default class ComponentLangue extends Vue {
   ...
   /**
    * Retourne les langues candidates
    * @return Liste des langues
    */
   get getLangueItems(): Array<ListItem> {
      return this.$store.state.blocLangue._candidates;
   }

   /**
    * Retourne les langues sélectionnées
    * @return Liste des langues
    */
   ...
   /**
    * Mise à jour des langues sélectionées
    */
   updateSelectedLangue(): void {
   ...
   /**
    * Supprime une langue de la sélection
    * @param value Langue à supprimer
    * @throws ValueError si la langue n'a pas été trouvé
    */
   removeItemLangue(value: ListItem): void {
