...
export default class ComponentPays extends Vue {
   ...
   eventUpdateBlocExternalOperator(): void {
      this.$store.dispatch('blocPaysExternalOperatorAction', this.external_operator_selected);
   }
   eventUpdateBlocInternalOperator(): void {
      this.$store.dispatch('blocPaysInternalOperatorAction', this.internal_operator_selected);
   }
