...
import {CheckboxesProvider, Ensemble, OperatorProvider} from '@/store/interfaces/BlocInterfaces';
...
export default class ComponentPlanConservationMetiers extends Vue {
   ...
   eventUpdateBlocExternalOperator(): void {
      this.$store.dispatch('blocPcpMetiersExternalOperatorAction', this.external_operator_selected);
   }

   eventUpdateBlocInternalOperator(): void {
      this.$store.dispatch('blocPcpMetiersInternalOperatorAction', this.internal_operator_selected);
   }
