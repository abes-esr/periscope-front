...
import ComponentRegions from '@/components/recherche/criteres/v1/Regions.vue';
import ComponentMetiers from '@/components/recherche/criteres/v1/Metiers.vue';
...
export default class PlanConservation extends Mixins(GlobalPropertiesMixin) {
   ...
   get getArrayRegions(): Array<CheckboxesProvider> {
      return this.$store.state.blocPcpRegions._candidates;
   }
   get getArrayMetiers(): Array<CheckboxesProvider> {
      return this.$store.state.blocPcpMetiers._candidates;
   }
